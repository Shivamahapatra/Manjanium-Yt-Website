...
export function SidebarLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-screen w-full flex-col md:flex-row bg-neutral-100 dark:bg-neutral-900 flex-1 mx-auto border border-neutral-200 dark:border-neutral-700 overflow-hidden">
